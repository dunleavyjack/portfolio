...
var LeonSans = (function (t) {
    ...
    function (t, r, i) {
        ...
        function D(t, r, i, e, a, s) {
            ...
            if (
                (1 == r.direction &&
                    (l = f(1 - a.drawing.value, s, s + n, 1, 0)),
                l > 0)
            ) {
                var o = i * l;
                t.setLineDash([i]),
        ...
        function T(t, r, i, e) {
            ...
            if (1 == r.drawing.value)
                for (a = r.lines.length, s = 0; s < a; s++)
                    I(t, r.lines[s], i, e);
            else
                for (
                    a = r.drawingPaths.length * r.drawing.value, s = 0;
                    s < a;
                    s++
                )
                ...
                convert: function (t, r) {
                    var i = j(this.x, t, this.ratio, r),
                        ...
                        f = (function (t, r, i) {
                            var e = 0;
                            'a' == t &&
                                (e = r.range.cr * i.scale * i.fontRatio);
                            return e;
                        })(this.type, t, r),
                        o = new z(this);
                    return (
        ...
        function q(t, r, i, e) {
            ...
            for (y = d.length, a = 0; a < y; a++) {
                ...
                1 == r.typo.p[a].d && p.reverse(),
                    p.length > 0 &&
                        ((p[0].start = 1), Array.prototype.push.apply(c, p));
            }
            return c;
        }
        function X(t, r, i) {
                ...
                M: Y(885, 330, 352, 0, 0, 0, 0, [
                    {
                        ...
                        v: [
                            ...
                            [
                                ...
                                163.5,
                                330,
                                { r: $(163.5, 330, 163.5, 330), f: 1 },
                            ],
                            [
                                'l',
                                166.5,
                                330,
                                { r: $(166.5, 330, 327, 0), f: 1, v: 1 },
                            ],
                            ['l', 327, 0, { r: Q, p: 1, f: 1 }],
                            ['l', 330, 0, { r: Q, f: 1, v: 1 }],
                ...
                W: Y(894, 390, 352, 0, 0, 0, 0, [
                    {
                        ...
                        v: [
                            ...
                            [
                                ...
                                87.5,
                                352,
                                { r: $(87.5, 352, 193.5, 0), f: 1, v: 1 },
                            ],
                            [
                                'l',
                                193.5,
                                0,
                                { r: $(87.5, 352, 193.5, 0), f: 1 },
                            ],
                            [
                                'l',
                                196.5,
                                0,
                                { r: $(196.5, 0, 302.5, 352), f: 1, v: 1 },
                            ],
                            [
                                'l',
                                302.5,
                                352,
                                { r: $(196.5, 0, 302.5, 352), f: 1 },
                            ],
                            [
                                'l',
                                305.5,
                                352,
                                { r: $(305.5, 352, 390, 0), f: 1, v: 1 },
                            ],
                ...
                w: Y(700, 310, 352, 0, 0, 0, 0, [
                    {
                        ...
                        v: [
                            ...
                            [
                                ...
                                79.5,
                                352,
                                { r: $(79.5, 352, 153.5, 130), f: 1, v: 1 },
                            ],
                            [
                                'l',
                                153.5,
                                130,
                                { y: 1, r: $(79.5, 352, 153.5, 130), f: 1 },
                            ],
                            [
                                'l',
                                156.5,
                            ...
                            [
                                ...
                                231.5,
                                352,
                                { r: $(156.5, 130, 231.5, 352), f: 1 },
                            ],
                            [
                                'l',
                                234.5,
                                352,
                                { r: $(234.5, 352, 310, 130), f: 1, v: 1 },
                            ],
                ...
                '%': Y(920, 388, 360, 0, 0, 0, 0, [
                    {
                        ...
                        v: [
                            [
                                ...
                                307.1,
                                5.1,
                                { x: 0, y: 0, r: $(307.1, 5.1, 80.9, 354.9) },
                            ],
            ...
            update(t, r, i, a, f, o, h) {
                ...
                for (var A of z)
                    for (var q of ((L = Vt(M, A.tw)), A.arr))
                        ...
                        (q.drawing = j),
                        q.typo.p))
                            for (var E of ((X.cv = []), X.v))
                                X.cv.push(E.convert(q, this));
        ...
        class Zt extends class {
            ...
            off(t, r) {
                if (void 0 === this.handlers_[t])
                    return (
                        console.error(
                            'This event: '.concat(t, ' does not exist')
                        ),
                        !1
                    );
                this.handlers_[t].listeners = this.handlers_[
                    t
                ].listeners.filter((t) => t.toString() !== r.toString());
            }
            dispatch(t, r) {
            ...
            constructor() {
                ...
                super(),
                    ...
                    (this.colorful_ = (function (t) {
                        for (
                            var r, i, e = t.slice(), a = e.length, s = a;
                            s--;
